...
public class TLEUserServiceImpl
  ...
  public void userDeletedEvent(UserDeletedEvent event) {
    ...
    // Suspended users
    SuspendedUserWrapperSettings suws =
        configService.getProperties(new SuspendedUserWrapperSettings());
  ...
  public void userIdChangedEvent(UserIdChangedEvent event) {
    ...
    // Roles
    updateRoles(
        SecurityConstants.getRecipient(Recipient.USER, event.getFromUserId()),
  ...
  public void groupIdChangedEvent(GroupIdChangedEvent event) {
    updateRoles(
        SecurityConstants.getRecipient(Recipient.GROUP, event.getFromGroupId()),
