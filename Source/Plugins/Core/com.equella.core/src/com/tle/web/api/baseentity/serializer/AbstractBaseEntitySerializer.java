...
public abstract class AbstractBaseEntitySerializer<
    ...
    implements BaseEntitySerializer<BE, BEB> {
  ...
  protected abstract ED createExistingEditor(
      BE entity, @Nullable String stagingUuid, @Nullable String lockId, boolean importing);
